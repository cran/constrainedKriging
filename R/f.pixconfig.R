...
#
# Kontrolle welche Polygone/Blšcke habe eine FlŠche die kleiner als die FlŠche eines Pixel ist
...
{
    ### einstellungen fŸr die ersten Simulationen !!!!!!!
    ##t.p.x.null <-  t.grid.bbox[1,1]  + 0.48*t.rowwidth  ## fŸr die Simulationsexperimente
    ##t.p.y.null <- t.grid.bbox[2,1] 
    delta.x.pix <-  0.5 * pixgridInfo$colwidth## + 3.5## fŸr die Simulationsexperimente
